...
var setupTicks = function setupTicks(_ref) {
  ...
  d3Root.select('.yTicks').append('g').selectAll('text').data(range(1, highestValue, highestValue / 10)).enter().append('text').text(function (i) {
    return Math.round(i);
  }).attrs({
  ...
  d3Root.select('.yTicks').append('g').selectAll('line').data(range(1, highestValue, highestValue / 10)).enter().append('line').attrs({
    class: function _class(i) {
      return 'yTick-line-' + i;
    },
    x1: yAxisOffset - 7,
