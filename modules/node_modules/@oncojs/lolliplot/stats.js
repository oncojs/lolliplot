  ...
  Object.keys(consequences).map(type => {
    consequencesContainer
      ...
      .on(`click`, () => {
        ...
        updateMutations({ d3, checked, mutationClass: `consequence`, type, data })
      })
  })
  ...
  Object.keys(impacts).map(type => {
    impactsContainer
      ...
      .on(`click`, () => {
        ...
        updateMutations({ d3, checked, mutationClass: `impact`, type, data })
      })
  })
